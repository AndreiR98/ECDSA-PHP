...
{
    protected function addPoints(ECpoint $firstPoint, ECpoint $secondPoint) : ECpoint {
        //Add 2 points in Jacobi coords, faster method always
        return $this->addPoint($secondPoint);
    }

    protected function subPoints(ECpoint $firstPoint, ECpoint $secondPoint) : ECpoint {
        return new ECpoint();
    }
    ...
    private function add_with_z2_1(ECpoint $secondPoint) : ECpoint {
        ...
        if (($r == 0)&&($H == 0)){
            return $this->double_with_z1($secondPoint->getX(), $this::getY());
        }
